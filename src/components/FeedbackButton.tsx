        ...
        <div className="fixed bottom-20 right-6 z-50 w-80 bg-surface rounded-xl shadow-xl border border-border overflow-hidden">
          {submitted ? (
            <div className="p-6 text-center">
              ...
              <p className="text-sm font-medium text-text-primary">감사합니다!</p>
              <p className="text-xs text-text-secondary">피드백이 전달되었습니다.</p>
            </div>
          ) : (
            <>
              <div className="px-4 py-3 border-b border-border">
                <h3 className="text-sm font-semibold text-text-primary">피드백 보내기</h3>
              </div>
